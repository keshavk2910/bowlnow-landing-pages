                      ...
                      <div className="mt-3 grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            min="1"
                            max="10"
                            value={field.minFAQs || 1}
                            onChange={(e) => handleFieldChange(index, 'minFAQs', parseInt(e.target.value))}
                            className='w-full px-2 py-1 border border-gray-300 rounded text-sm'
                          />
                        </div>
                        <div>
                          ...
                          <input
                            ...
                            min="1"
                            max="50"
                            value={field.maxFAQs || 20}
                            onChange={(e) => handleFieldChange(index, 'maxFAQs', parseInt(e.target.value))}
                            className='w-full px-2 py-1 border border-gray-300 rounded text-sm'
                          />
                        </div>
                      </div>
