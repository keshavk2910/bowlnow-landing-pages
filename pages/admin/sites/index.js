        ...
        {!loading && filteredSites.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 mb-4">
              {searchTerm ? 'Try adjusting your search terms' : 'Create your first site to get started'}
            </p>
            <Link
              href="/admin/sites/new"
      ...
      <div className="p-6">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-2">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900">{site.client_name}</h3>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-gray-900">{site.pageCount}</div>
            <div className="text-sm text-gray-500">Pages</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-gray-900">{site.customerCount}</div>
            <div className="text-sm text-gray-500">Customers</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-gray-900">{site.orderCount}</div>
            <div className="text-sm text-gray-500">Orders</div>
          </div>
          <div className="text-center">
            <div className="text-2xl font-bold text-gray-900">${site.totalRevenue.toFixed(0)}</div>
        ...
        <div className="flex space-x-2">
          ...
          >
            {isUpdating ? 'Updating...' : site.status === 'active' ? 'Deactivate' : 'Activate'}
          </button>
