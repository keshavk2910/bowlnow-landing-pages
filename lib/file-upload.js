...
export function generateFilePath(siteName, pageName, fileName, isLogo = false) {
...
export async function uploadFileToStorage(file, siteName, pageName, isLogo = false) {
  try {
    const filePath = generateFilePath(siteName, pageName, file.name, isLogo)
