...
export function generateFilePath(siteName, pageName, fileName) {
  ...
  return `site-files/${sanitizedSiteName}/${sanitizedPageName}/${sanitizedFileName}`
}

// Upload file to Supabase Storage
export async function uploadFileToStorage(file, siteName, pageName) {
  try {
    const filePath = generateFilePath(siteName, pageName, file.name)
