...
export default function EventsTemplate({
  ...
  const heroTitle =
    content.hero_title || 'Exceptional Events, Flawlessly Executed';
  ...
  const eventTypes = content.event_types || [
    ...
    },
    {
      ...
      description: 'Connect industry professionals',
      icon: '🤝',
    },
    {
      name: 'Training Seminars',
      description: 'Educational workshops and sessions',
      icon: '📚',
    },
    {
    ...
    <div className='min-h-screen bg-white'>
      ...
      >
        <div className='max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 z-10'>
          <h1 className='text-5xl md:text-7xl font-bold mb-6'>{heroTitle}</h1>
          <p className='text-xl md:text-2xl mb-8 text-gray-200 max-w-3xl mx-auto'>
            From intimate corporate meetings to large-scale conferences, we
            deliver professional events that exceed expectations
          </p>
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          <div className='text-center mb-16'>
            ...
            <p className='text-xl text-gray-600 max-w-3xl mx-auto'>
              We specialize in creating impactful business events that drive
            ...
            <div className='space-y-8'>
              ...
              <div className='flex items-start space-x-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-600'>
                    Tailored event experiences that align with your objectives
                  </p>
                </div>
              </div>
              ...
              <div className='flex items-start space-x-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-600'>
                    Reliable execution with attention to timelines and budgets
                  </p>
                </div>
              </div>
            </div>
            ...
            {formSubmitted ? (
              <div className='text-center py-12'>
                ...
                <p className='text-xl text-gray-600 mb-4'>
                  Thank you for considering {site.client_name} for your upcoming
                  event.
                </p>
                <p className='text-gray-600'>
                  Our event planning specialist will contact you within 24 hours
